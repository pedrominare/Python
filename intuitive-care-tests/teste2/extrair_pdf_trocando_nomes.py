...
# trocando os simbolos
print("O programa agora irá substituir 'OD' por 'Seg. Odontológica' e 'AMB' por 'Seg. Ambulatorial'.\n")
writer.replace(to_replace="OD", value="OD: Seg. Odontológica", inplace=True)
writer.replace(to_replace="AMB", value="AMB: Seg. Ambulatorial", inplace=True)
